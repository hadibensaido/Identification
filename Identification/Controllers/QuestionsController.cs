...
namespace Identification.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idQuestion,libelleQuestion")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idQuestion,libelleQuestion")] Question question)
        {
            if (ModelState.IsValid)
            {
